...
var TASK_RUNNABLE   = 1,  /* default state; task is runnable */
    TASK_DEAD       = 2,  /* task is dead. done. gone. */
    TASK_BLOCKED    = 3,  /* task blocked waiting on something e.g. IO, delay */
    TASK_RESUMED    = 4;  /* task has just resumed. for use in native functions */
            ...
            switch (op & 0x000000FF) {
                ...
                case OP_SPAWN:
                    ...
                    if (callfn && callfn.__type__ == types.T_FN) {
                        ...
                        frame.sp -= nargs;
                        var spawnedTask = spawn(callfn, task.stack.slice(frame.sp, nargs));
                        task.stack[frame.sp++] = 1; // TODO: task should be language type
...
exports.TASK_RUNNABLE   = TASK_RUNNABLE;
exports.TASK_DEAD       = TASK_DEAD;
exports.TASK_BLOCKED    = TASK_BLOCKED;
exports.TASK_RESUMED    = TASK_RESUMED;